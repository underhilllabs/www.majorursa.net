 ...
 * 1. Rename each function and instance of "adaptivemu" to match
 *    your subthemes name, e.g. if your theme name is "footheme" then the function
 *    name will be "footheme_preprocess_hook". Tip - you can search/replace
 *    on "adaptivemu".
 * 2. Uncomment the required function to use.
 * 3. Read carefully, especially within adaptivemu_preprocess_html(), there
 ...
 */
function adaptivemu_preprocess_html(&$vars) {
  // Load the media queries styles
  // Remember to rename these files to match the names used here - they are
  // in the CSS directory of your subtheme.
  $media_queries_css = array(
    'adaptivemu.responsive.style.css',
    'adaptivemu.responsive.gpanels.css'
  );
  load_subtheme_media_queries($media_queries_css, 'adaptivemu');
  ...
  */
  ...
  load_subtheme_ie_styles($ie_files, 'adaptivemu');
  // */
...
function adaptivemu_process_html(&$vars) {
}
// */
...
function adaptivemu_preprocess_page(&$vars) {
}

function adaptivemu_process_page(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function adaptivemu_preprocess_node(&$vars) {
}

function adaptivemu_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function adaptivemu_preprocess_comment(&$vars) {
}

function adaptivemu_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function adaptivemu_preprocess_block(&$vars) {
}

function adaptivemu_process_block(&$vars) {
}
// */
